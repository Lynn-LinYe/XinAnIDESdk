...
class InstrumentLog {
  ...
  taskDone () {
    let summry = this.suiteService.getSummry()
    var action = {}
    var actionData = {}
    actionData.data = '\\' + 'INSTRUMENTATION_RESULT: stream=Tests run: ' + summry.total + ',  Failures: ' + summry.failure + ' ' + '\\' + 'INSTRUMENTATION_CODE: ' + (summry.failure > 0 ? -1 : 0) + '\\'
  ...
  specStart () {
    ...
    actionData.data += '\\' + 'INSTRUMENTATION_STATUS: numtests=' + suiteService.getSummry().total
  ...
  specDone () {
    ...
    actionData.data += '\\' + 'INSTRUMENTATION_STATUS: id=JS'
    actionData.data += '\\' + 'INSTRUMENTATION_STATUS: numtests=' + this.suiteService.getSummry().total
    let emsg = ''
