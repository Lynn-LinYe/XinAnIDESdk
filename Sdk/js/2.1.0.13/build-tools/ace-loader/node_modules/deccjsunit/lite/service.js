...
var ReportService = (function () {
  ...
  _createClass(ReportService, [{
    ...
    value: function taskDone () {
      this.sleep(200)
      var summry = this.suiteService.getSummry()
      console.info('total cases:' + summry.total + ';failure ' + summry.failure + ',' + 'error ' + summry.error + ',pass ' + (summry.total - summry.error - summry.failure))
...
var ConfigService = (function () {
  ...
  _createClass(ConfigService, [{
    ...
    value: function filterSpec (spec, coreContext) {
      ...
      var testTypeFi = fi & 65535
      var testType = this.filter & 65535
